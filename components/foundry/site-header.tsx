  ...
  return (
    <header className="site-header">
      ...
      <nav aria-label="Primary navigation">
        <Link href="/#lanes"><NavIcon icon="nav-people" />People</Link>
        <Link href="/#how"><NavIcon icon="nav-how" />How</Link>
        <Link href="/proof"><NavIcon icon="nav-proof" />Proof</Link>
        <Link href="/pricing"><NavIcon icon="nav-dues" />Pricing</Link>
        <Link href="/bellows"><NavIcon icon="nav-bellows" />Bellows</Link>
