  ...
  return (
    <div className="concierge-user-flow concierge-user-flow--60s">
      <header className="concierge-user-flow__hero panel">
        <p className="eyebrow">Worked example · 60-second read</p>
      ...
      <div className="concierge-user-flow__steps">
        ...
        {speakerRead ? (
          <>
            <FlowCard step={2} title="What might be happening?" variant="speaker">
            ...
            <FlowCard step={3} title="What supports that read?" variant="why">
            ...
            <FlowCard step={4} title="What would change the read?" variant="falsify">
