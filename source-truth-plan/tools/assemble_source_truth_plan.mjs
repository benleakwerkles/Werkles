...
const absoluteSources = [
  ...
  ["speaker_atlas", "C:/speaker/bootloader/profiles/Skybro.Betsy.json"],
  ["speaker_atlas", "C:/speaker/bootloader/profiles/Petra.Betsy.json"],
  ["speaker_atlas", "C:/speaker/bootpacks/out/Skybro.Betsy.BOOTPACK.md"],
  ["speaker_atlas", "C:/speaker/bootpacks/out/Petra.Betsy.NERDKLE_BRAINBOOT.BOOTPACK.md"],
...
function writeGeneratedFiles(manifest, missing, chatlogIndex) {
  ...
  fs.writeFileSync(
    path.join(planRoot, "BOOTPACK_SOURCE_TRUTH.md"),
