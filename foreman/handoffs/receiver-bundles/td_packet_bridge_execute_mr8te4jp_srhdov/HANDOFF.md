...
Receiver: ReceiverHandoffFixture@Betsy
Packet lane: TinkerDen bridge execute
Packet from/to: TinkerDen@Betsy -> Maker@Betsy
Generated: 2026-07-06T06:24:50.352Z

## Files

- Packet copy: `foreman/handoffs/receiver-bundles/td_packet_bridge_execute_mr8te4jp_srhdov/packet.json`
- Receipt template: `foreman/handoffs/receiver-bundles/td_packet_bridge_execute_mr8te4jp_srhdov/receipt-template.json`
- Manifest: `foreman/handoffs/receiver-bundles/td_packet_bridge_execute_mr8te4jp_srhdov/manifest.json`
...
```powershell
node scripts/foreman/organism-receiver-receipt-post.mjs --receipt foreman/handoffs/receiver-bundles/td_packet_bridge_execute_mr8te4jp_srhdov/receipt-template.json --base-url http://127.0.0.1:3000 --detected-by ReceiverHandoffFixture@Betsy
```
