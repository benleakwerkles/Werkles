...
Generated: 2026-07-06T07:31:14.572Z

## Files

- Packet copy: `foreman/handoffs/receiver-bundles/receipts_ready_post_success_mr8wiiud/packet.json`
- Receipt template: `foreman/handoffs/receiver-bundles/receipts_ready_post_success_mr8wiiud/receipt-template.json`
- Manifest: `foreman/handoffs/receiver-bundles/receipts_ready_post_success_mr8wiiud/manifest.json`
...
```powershell
node scripts/foreman/organism-receiver-receipt-post.mjs --receipt foreman/handoffs/receiver-bundles/receipts_ready_post_success_mr8wiiud/receipt-template.json --base-url http://127.0.0.1:3000 --detected-by ReceiptsReadyPostSuccessSmoke@Betsy
```
