...
Generated: 2026-07-06T06:53:21.295Z

## Files

- Packet copy: `foreman/handoffs/receiver-bundles/ui_fill_return_control_mr8v5sqy/packet.json`
- Receipt template: `foreman/handoffs/receiver-bundles/ui_fill_return_control_mr8v5sqy/receipt-template.json`
- Manifest: `foreman/handoffs/receiver-bundles/ui_fill_return_control_mr8v5sqy/manifest.json`
...
```powershell
node scripts/foreman/organism-receiver-receipt-post.mjs --receipt foreman/handoffs/receiver-bundles/ui_fill_return_control_mr8v5sqy/receipt-template.json --base-url http://127.0.0.1:3000 --detected-by ReceiverFillReturnControlSmoke@Betsy
```
