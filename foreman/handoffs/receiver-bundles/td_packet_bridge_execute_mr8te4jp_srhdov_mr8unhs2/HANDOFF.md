...
Generated: 2026-07-06T06:39:07.204Z

## Files

- Packet copy: `foreman/handoffs/receiver-bundles/td_packet_bridge_execute_mr8te4jp_srhdov_mr8unhs2/packet.json`
- Receipt template: `foreman/handoffs/receiver-bundles/td_packet_bridge_execute_mr8te4jp_srhdov_mr8unhs2/receipt-template.json`
- Manifest: `foreman/handoffs/receiver-bundles/td_packet_bridge_execute_mr8te4jp_srhdov_mr8unhs2/manifest.json`
...
```powershell
node scripts/foreman/organism-receiver-receipt-post.mjs --receipt foreman/handoffs/receiver-bundles/td_packet_bridge_execute_mr8te4jp_srhdov_mr8unhs2/receipt-template.json --base-url http://127.0.0.1:3000 --detected-by Maker@Betsy
```
