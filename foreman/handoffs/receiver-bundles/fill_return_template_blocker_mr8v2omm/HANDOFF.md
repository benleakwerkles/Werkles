...
Receiver: ReceiverFillReturnApiSmoke@Betsy
Packet lane: TinkerDen bridge execute
Packet from/to: TinkerDen@Betsy -> Maker@Betsy
Generated: 2026-07-06T06:50:56.222Z

## Files

- Packet copy: `foreman/handoffs/receiver-bundles/fill_return_template_blocker_mr8v2omm/packet.json`
- Receipt template: `foreman/handoffs/receiver-bundles/fill_return_template_blocker_mr8v2omm/receipt-template.json`
- Manifest: `foreman/handoffs/receiver-bundles/fill_return_template_blocker_mr8v2omm/manifest.json`
...
```powershell
node scripts/foreman/organism-receiver-receipt-post.mjs --receipt foreman/handoffs/receiver-bundles/fill_return_template_blocker_mr8v2omm/receipt-template.json --base-url http://127.0.0.1:3000 --detected-by ReceiverFillReturnApiSmoke@Betsy
```
