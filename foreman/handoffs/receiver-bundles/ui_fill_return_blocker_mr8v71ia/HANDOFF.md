...
Generated: 2026-07-06T06:54:19.345Z

## Files

- Packet copy: `foreman/handoffs/receiver-bundles/ui_fill_return_blocker_mr8v71ia/packet.json`
- Receipt template: `foreman/handoffs/receiver-bundles/ui_fill_return_blocker_mr8v71ia/receipt-template.json`
- Manifest: `foreman/handoffs/receiver-bundles/ui_fill_return_blocker_mr8v71ia/manifest.json`
...
```powershell
node scripts/foreman/organism-receiver-receipt-post.mjs --receipt foreman/handoffs/receiver-bundles/ui_fill_return_blocker_mr8v71ia/receipt-template.json --base-url http://127.0.0.1:3000 --detected-by ReceiverFillReturnControlSmoke@Betsy
```
