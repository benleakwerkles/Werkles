...
Generated: 2026-07-06T07:30:07.942Z

## Files

- Packet copy: `foreman/handoffs/receiver-bundles/receipts_ready_post_success_mr8wh3fq/packet.json`
- Receipt template: `foreman/handoffs/receiver-bundles/receipts_ready_post_success_mr8wh3fq/receipt-template.json`
- Manifest: `foreman/handoffs/receiver-bundles/receipts_ready_post_success_mr8wh3fq/manifest.json`
...
```powershell
node scripts/foreman/organism-receiver-receipt-post.mjs --receipt foreman/handoffs/receiver-bundles/receipts_ready_post_success_mr8wh3fq/receipt-template.json --base-url http://127.0.0.1:3000 --detected-by ReceiptsReadyPostSuccessSmoke@Betsy
```
