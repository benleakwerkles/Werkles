...
Receiver: ReceiverPostReturnSmoke@Betsy
Packet lane: TinkerDen bridge execute
Packet from/to: TinkerDen@Betsy -> Maker@Betsy
Generated: 2026-07-06T06:45:40.678Z

## Files

- Packet copy: `foreman/handoffs/receiver-bundles/ui_post_return_smoke_mr8uvxbq/packet.json`
- Receipt template: `foreman/handoffs/receiver-bundles/ui_post_return_smoke_mr8uvxbq/receipt-template.json`
- Manifest: `foreman/handoffs/receiver-bundles/ui_post_return_smoke_mr8uvxbq/manifest.json`
...
```powershell
node scripts/foreman/organism-receiver-receipt-post.mjs --receipt foreman/handoffs/receiver-bundles/ui_post_return_smoke_mr8uvxbq/receipt-template.json --base-url http://127.0.0.1:3000 --detected-by ReceiverPostReturnSmoke@Betsy
```
