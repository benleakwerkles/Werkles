...
Receiver: ReceiverPostReturnBlockerSmoke@Betsy
Packet lane: TinkerDen bridge execute
Packet from/to: TinkerDen@Betsy -> Maker@Betsy
Generated: 2026-07-06T06:47:58.112Z

## Files

- Packet copy: `foreman/handoffs/receiver-bundles/ui_post_template_return_blocker_mr8uytjj/packet.json`
- Receipt template: `foreman/handoffs/receiver-bundles/ui_post_template_return_blocker_mr8uytjj/receipt-template.json`
- Manifest: `foreman/handoffs/receiver-bundles/ui_post_template_return_blocker_mr8uytjj/manifest.json`
...
```powershell
node scripts/foreman/organism-receiver-receipt-post.mjs --receipt foreman/handoffs/receiver-bundles/ui_post_template_return_blocker_mr8uytjj/receipt-template.json --base-url http://127.0.0.1:3000 --detected-by ReceiverPostReturnBlockerSmoke@Betsy
```
