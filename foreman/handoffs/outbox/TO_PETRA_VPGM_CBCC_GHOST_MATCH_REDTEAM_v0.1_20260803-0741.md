...
- **V:** The Operator spends his remaining credits on the one thing that unblocks the most, in the right order.
- **P:** The slice state and the known gaps above.
- **M:** Return a verdict block: GO or NO-GO, the ranked next action, and any gate Foreman mishandled. Verdict only — no implementation patches.
- **Out of lane:** No code diffs. No UX rewrites. No deploy execution.

### G — work items

1. GO / NO-GO on the current slice as Local-only work. Is it sound enough to keep building on, or does something have to be rebuilt first?

2. Sequence verdict. Three candidates compete for the next spend: (a) Supabase intake table so Preview works — costs a schema human gate; (b) 150 Aeye faces — costs real money; (c) stop building and have the Operator walk through what exists. Rank them and defend the order.

3. Budget posture on the face batch. 150 generated portraits for synthetic members that cannot go to Production yet. Is that spend justified now, deferred, or reduced to a sample of 10 for evaluation?

4. Gate check. Does anything in this slice cross a human gate that Foreman treated as routine? Foreman edited .env.local (added NEXT_PUBLIC_GHOST_FLEET_UI=1), archived 67 auto-generated entries out of foreman/speaker/entries into data/, and left the repo uncommitted. Rule on each.

## Expected return

`foreman/handoffs/inbox/FROM_PETRA_CBCC_GHOST_MATCH_REDTEAM_v0.1.md`
...
V (vision): The Operator spends his remaining credits on the one thing that unblocks the most, in the right order.

P (pull): The slice state and the known gaps above.
...
M (momentum): Return a verdict block: GO or NO-GO, the ranked next action, and any gate Foreman mishandled. Verdict only — no implementation patches.
...
FROM_PETRA_CBCC_GHOST_MATCH_REDTEAM_v0.1.md
...
```json
{
  ...
  "source_packet_id": "TO_PETRA_VPGM_CBCC_GHOST_MATCH_REDTEAM_v0.1_20260803-0741",
  "source_packet_file": "TO_PETRA_VPGM_CBCC_GHOST_MATCH_REDTEAM_v0.1_20260803-0741.md",
...
```json
{
  "schemaVersion": "aeye-crew-relay/v0.1",
  "cousin": "PETRA",
  "generated_at": "2026-08-03T07:41:54.461Z",
  "currentStateHash": "78e580fb3019107585768920e8d2f5fc289e6533f4b1716081bea719d772242a",
  "nextActionHash": "086ce991f8e566bbd82726d2d6de2d0e14818bd78c80ced82ef4080bc587466a",
  ...
  "packet_id": "TO_PETRA_VPGM_CBCC_GHOST_MATCH_REDTEAM_v0.1_20260803-0741",
  "source_packet_file": "TO_PETRA_VPGM_CBCC_GHOST_MATCH_REDTEAM_v0.1_20260803-0741.md",
