...
5. SEQUENCE VERDICT. Three things compete for the next spend: (a) apply whatever this red team returns; (b) have the Operator walk the site now; (c) unblock Preview, which costs a schema human gate. Rank them and defend the order.

6. CREDIT DISCIPLINE. The Operator has said credits are scarce and that rework is the expensive failure. Name the one change to how the Foreman operates that would most reduce rework, stated as a rule the Foreman must follow every session.
...
```json
{
  ...
  "source_packet_id": "TO_PETRA_VPGM_CBCC_RECOMMENDATION_VIEW_REDTEAM_v0.1_20260803-1553",
  "source_packet_file": "TO_PETRA_VPGM_CBCC_RECOMMENDATION_VIEW_REDTEAM_v0.1_20260803-1553.md",
...
```json
{
  "schemaVersion": "aeye-crew-relay/v0.1",
  "cousin": "PETRA",
  "generated_at": "2026-08-03T15:53:16.266Z",
  "currentStateHash": "78e580fb3019107585768920e8d2f5fc289e6533f4b1716081bea719d772242a",
  "nextActionHash": "086ce991f8e566bbd82726d2d6de2d0e14818bd78c80ced82ef4080bc587466a",
  ...
  "packet_id": "TO_PETRA_VPGM_CBCC_RECOMMENDATION_VIEW_REDTEAM_v0.1_20260803-1553",
  "source_packet_file": "TO_PETRA_VPGM_CBCC_RECOMMENDATION_VIEW_REDTEAM_v0.1_20260803-1553.md",
