...
- **V:** A welder with two trucks reads one screen and knows what to do next, why, and what would change the answer — and does not feel judged, sold to, or handled by a machine.
- **P:** Every string in the live strings list, the seven-section order, and the measured font sizes. Your own imagery and UX brief from 2026-07-03 was one of the two receipts that sat unread — this pass claims to honor its legibility requirement. Check that claim.
- **M:** Return the three changes that most reduce trust damage, ranked, each with replacement copy written out verbatim so it can be pasted in. State clearly whether this surface should ship to a walkthrough as-is. If the answer is no, say what blocks it.
- **Out of lane:** No SQL, security, billing, or deploy opinions. If something reads like a trust or compliance defect, name it and route it to Bean rather than solving it.

### G — work items

1. Does this implementation honor Maker's spec or just its checklist? Maker asked for a concierge readout that names the deeper need and shows its work. Read the seven sections as a whole and say whether they add up to that, or whether the Foreman built the sections and missed the point.

2. The verdict copy. 'Recommended: build proof before asking for a Backer.' A man with two trucks and a lost bid asked for help and is being told to go do paperwork. Is that honest guidance or a scold? Rewrite it if it lands wrong, and keep whatever honesty it has.

3. 'Saw:' and 'Matters:' as visible labels on every reason. Attentive, or does it read like a form the machine filled out? The 'Matters' text is static copy the Foreman wrote per signal type and presents to the member as Werkles's judgment. Rule on whether that is defensible.

4. MEASURED: body paragraphs render 12.2px BOLD, strength bands 11.2px, disabled-knock explanation 13.1px, reason text 14.7px. Contrast passes AA at 11.6:1 or better. Your prior brief called legibility a blocking bug that had already come up twice. Rule on these sizes and give me the minimum body size and weight you will accept.

5. A section headed 'The doors this points at' that then says 'No doors listed on purpose.' Is a section that shows nothing earning its space, or should it collapse into the verdict?

6. The bands. Strong / Medium / Thin / Watch, replacing 'fit 54'. Is 'Watch' legible to a normal person as a caution, or does it read as a verb? Is 'Thin' insulting when it describes a person?

7. Section order. Desktop shows header, verdict, receipt, interpretation, reasons, doors, alternatives, triggers, next action. Maker's spec put the receipt and interpretation ABOVE the verdict on desktop and the verdict first on mobile. The Foreman put the verdict first on both. Rule on it.

## Expected return

`foreman/handoffs/inbox/FROM_ENDER_CBCC_RECOMMENDATION_VIEW_REDTEAM_v0.1.md`
...
V (vision): A welder with two trucks reads one screen and knows what to do next, why, and what would change the answer — and does not feel judged, sold to, or handled by a machine.

P (pull): Every string in the live strings list, the seven-section order, and the measured font sizes. Your own imagery and UX brief from 2026-07-03 was one of the two receipts that sat unread — this pass claims to honor its legibility requirement. Check that claim.
...
M (momentum): Return the three changes that most reduce trust damage, ranked, each with replacement copy written out verbatim so it can be pasted in. State clearly whether this surface should ship to a walkthrough as-is. If the answer is no, say what blocks it.
...
FROM_ENDER_CBCC_RECOMMENDATION_VIEW_REDTEAM_v0.1.md
...
```json
{
  ...
  "source_packet_id": "TO_ENDER_VPGM_CBCC_RECOMMENDATION_VIEW_REDTEAM_v0.1_20260803-1553",
  "source_packet_file": "TO_ENDER_VPGM_CBCC_RECOMMENDATION_VIEW_REDTEAM_v0.1_20260803-1553.md",
...
```json
{
  "schemaVersion": "aeye-crew-relay/v0.1",
  "cousin": "ENDER",
  "generated_at": "2026-08-03T15:53:16.264Z",
  "currentStateHash": "78e580fb3019107585768920e8d2f5fc289e6533f4b1716081bea719d772242a",
  "nextActionHash": "086ce991f8e566bbd82726d2d6de2d0e14818bd78c80ced82ef4080bc587466a",
  ...
  "packet_id": "TO_ENDER_VPGM_CBCC_RECOMMENDATION_VIEW_REDTEAM_v0.1_20260803-1553",
  "source_packet_file": "TO_ENDER_VPGM_CBCC_RECOMMENDATION_VIEW_REDTEAM_v0.1_20260803-1553.md",
