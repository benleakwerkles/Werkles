...
| **Seat** | Comptroller |
| **Platform** | ChatGPT |
| **Edge tab** | #1 → https://chatgpt.com/ |
| **Lane** | Gate verdict and crew routing — GO/NO-GO, slice choice, Gate 05 posture. Not implementation patches. |
| **Relay job (this command)** | Acknowledge Comptroller lane; confirm you will issue verdict blocks, not code diffs. |
...
- push
- SQL apply
- implementation patches instead of verdict
...
| Response inbox | `foreman/handoffs/inbox/` as `FROM_PETRA_*.md` |
...
- `nextActionHash`: `c149c59bf1609e42213cc6d77d842f3d01efac6360c88bf15ccd10e39d420415` (trunc: c149c59bf160...)
- `currentStateHash`: `376b22166a2cfa0aec0481cdf63ca9afadcabe0c2b9a14ffd952b45b1b36f1f4` (trunc: 376b22166a2c...)

---

## Required response (Petra)

Reply with a `FROM_PETRA_RELAY_ROLE_ACK_*.md` saved to inbox (Ben will paste your reply into a file, or you output markdown Ben saves).

Include **Relay metadata** JSON with all `REQUIRED_RESPONSE_FIELDS` from schema plus:

- `VERDICT`: one line — e.g. `ROLE_ACK — PETRA lane understood`
- `CONFIDENCE`: `HIGH` or `LOW`
- `UNKNOWNS`: `none` or list; say **outside my lane** if unsure
- `source_packet_id`: `TO_PETRA_RELAY_ROLE_AWARENESS_SYNC_v0.1_20260531-0402`
- `source_packet_file`: `TO_PETRA_RELAY_ROLE_AWARENESS_SYNC_v0.1_20260531-0402.md`
...
```json
{
  ...
  "cousin": "PETRA",
  "generated_at": "2026-05-31T04:02:17.140Z",
  "currentStateHash": "376b22166a2cfa0aec0481cdf63ca9afadcabe0c2b9a14ffd952b45b1b36f1f4",
  "nextActionHash": "c149c59bf1609e42213cc6d77d842f3d01efac6360c88bf15ccd10e39d420415",
  ...
  "packet_id": "TO_PETRA_RELAY_ROLE_AWARENESS_SYNC_v0.1_20260531-0402",
  "source_packet_file": "TO_PETRA_RELAY_ROLE_AWARENESS_SYNC_v0.1_20260531-0402.md",
