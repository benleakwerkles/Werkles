...
- **V:** A member reads their ranked candidates and feels like a careful person read their intake — not like a scoring engine assigned them a number.
- **P:** The four member surfaces and every reason string listed above.
- **M:** Return the three changes that would most reduce trust damage, ranked, each with the replacement copy written out. If a surface should not ship as-is, say so plainly.
- **Out of lane:** No SQL, security, billing, or deploy opinions. If something looks like a trust or compliance defect, name it and route it to Bean instead of solving it.

### G — work items

1. The fit score. '#1 Omar Nguyen · fit 54' — does an integer imply precision Werkles has not earned? Would a band (strong / worth a look / thin) be more honest, or does that just hide the same guess?

2. Reason phrasing. The engine quotes the member's own blocker words back at them ('your blocker language: guarantor, lease'). Does that read as attentive or as a machine echoing keywords? Rewrite the two worst offenders.

3. Blocker stacking. Every card ends with 'Werkles cannot send, apply, introduce, or commit anything for you.' Repeated twelve times down a list. Necessary honesty or noise that trains people to skip the warnings?

4. The synthetic disclosure. Members labelled 'synthetic' sit next to real-sounding names, cities, and needs. Is the current label enough, or does the whole card need to look different?

5. The empty state: 'No synthetic member scored an honest reason against your intake. Empty is a valid answer.' Does that land as integrity or as failure?

6. Workshop opener: 'Your answers point at money or a guarantor. Werkles treats that as a hypothesis to test, not a diagnosis.' Is 'hypothesis' the right register for someone stressed about a lease?

## Expected return

`foreman/handoffs/inbox/FROM_ENDER_CBCC_GHOST_MATCH_REDTEAM_v0.1.md`
...
V (vision): A member reads their ranked candidates and feels like a careful person read their intake — not like a scoring engine assigned them a number.

P (pull): The four member surfaces and every reason string listed above.
...
M (momentum): Return the three changes that would most reduce trust damage, ranked, each with the replacement copy written out. If a surface should not ship as-is, say so plainly.
...
FROM_ENDER_CBCC_GHOST_MATCH_REDTEAM_v0.1.md
...
```json
{
  ...
  "source_packet_id": "TO_ENDER_VPGM_CBCC_GHOST_MATCH_REDTEAM_v0.1_20260803-0741",
  "source_packet_file": "TO_ENDER_VPGM_CBCC_GHOST_MATCH_REDTEAM_v0.1_20260803-0741.md",
...
```json
{
  "schemaVersion": "aeye-crew-relay/v0.1",
  "cousin": "ENDER",
  "generated_at": "2026-08-03T07:41:54.458Z",
  "currentStateHash": "78e580fb3019107585768920e8d2f5fc289e6533f4b1716081bea719d772242a",
  "nextActionHash": "086ce991f8e566bbd82726d2d6de2d0e14818bd78c80ced82ef4080bc587466a",
  ...
  "packet_id": "TO_ENDER_VPGM_CBCC_GHOST_MATCH_REDTEAM_v0.1_20260803-0741",
  "source_packet_file": "TO_ENDER_VPGM_CBCC_GHOST_MATCH_REDTEAM_v0.1_20260803-0741.md",
