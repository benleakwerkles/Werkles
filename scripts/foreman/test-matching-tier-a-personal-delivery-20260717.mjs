...
assert.match(personalRoute, /success: true, persisted: false, status: "profile_required"/);
assert.match(personalRoute, /success: true, persisted: false, status: "personal", session/);
...
assert.match(contract, /value\.source\.mode === "authenticated_profile"/);
